...
const _generarPdfAccionBytes = async (id, firmante_id) => {
...
// ─── ENDPOINT HTTP (mantiene compatibilidad) ──────────────────
...
export const generarPdfAccionBuffer = async (id, firmante_id) => {
  return await _generarPdfAccionBytes(id, firmante_id);
};
